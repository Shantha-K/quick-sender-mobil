...
const ParcelDetailsMapToggle = ({ navigation, route }) => {
        ...
        <ScrollView contentContainerStyle={{ paddingBottom: 32 }}>
          ...
          <View style={styles.infoCard}>
            ...
            <View style={styles.cardRow}>
              ...
              <Text style={styles.cardAddress}>{parcel?.from || parcel?.senderAddress || '1-10, Halmart apartments, BTM Layout, Bangalore, 561011'}</Text>
            </View>
            <View style={styles.cardRow}>
              <View style={styles.dotRed} />
              <Text style={styles.cardAddress}>{parcel?.to || parcel?.receiverAddress || '1-10, Halmart apartments, BTM Layout, Bangalore, 561012'}</Text>
            </View>
          </View>
...
const styles = StyleSheet.create({
  ...
  // removed toggleRow and toggleBtn styles
  card: {
...
export default ParcelDetailsMapToggle;
